...
exports.OrderTemplate = function (order,companyName) {
    var template = ` <div>
    <div style="background-color: #fcfaff; width: 100%; height: 60px; border-bottom: 1px solid rgb(204, 204, 204);">
        <h1 style="font-family: arial; font-weight: 200; font-size: 14px; color: #363d71; padding-top: 25px; padding-left: 20px;">Owner & Encumbrance Report</h1>
    </div>
    <div style="background-color: white; border-bottom: 2px solid #575c77; padding-bottom: 10px; float: left; width: 90%; min-height: 1px; padding-left: 5%;">
        <div>
            <h1 style="font-family: arial; font-weight: 200; font-size: 12px; color: #363d71;  margin-bottom: 0.1rem;">Requestor</h1>
        </div>
    ...
    <div style="background-color: white; border-bottom: 2px solid #575c77; padding-bottom: 10px; float: left; width: 90%; min-height: 1px; padding-left: 5%;">
        <div>
            <h1 style="font-family: arial; font-weight: 200; font-size: 12px; color: #363d71;  margin-bottom: 0.1rem;">Requested For</h1>
        </div>
        ...
        <div style="width: 100%; float: left;">
            <div style="width: 100%; float: left; ">
                <h1 style="font-family: arial; font-weight: bold; font-size: 8px; color: #2d3665; float: left; margin-bottom: 0.1rem;">Persons</h1>
            </div>
        </div>
    ...
    <div style="background-color: white; border-bottom: 1px solid #575c77; padding-bottom: 10px; float: left; width: 90%; min-height: 1px; padding-left: 5%;">
        <div>
            <h1 style="font-family: arial; font-weight: 200; font-size: 12px; color: #363d71;  margin-bottom: 0.1rem;">Service Requested</h1>
        </div>

        <div style="width: 50%; float: left;">
            <div style="width: 100%; float: left;">
                <h1 style="font-family: Roboto; font-weight: bold; font-size: 8px; color: #2d3665; float: left;">Report Type:</h1>
                <h1 style="font-family: arial; font-size: 8px; color: #2d3665; padding-left: 70px; font-weight: 200; margin-bottom: 0.1rem;">${valueCheck.isNullOrUndefined(order.servicesRequested.reportType)}</h1>
            </div>
        </div>

        <div style="width: 50%; float: left;">
            <div style="width: 100%; float: left;">
                <h1 style="font-family: Roboto; font-weight: bold; font-size: 8px; color: #2d3665; float: left;">Report Delivery:</h1>
                <h1 style="font-family: arial; font-size: 8px; color: #2d3665; padding-left: 70px; font-weight: 200; margin-bottom: 0.1rem;">${valueCheck.isNullOrUndefined(order.servicesRequested.reportDelivery)}</h1>
            </div>
        </div>

        <div style="width: 50%; float: left;">
            <div style="width: 100%; float: left; ">
                <h1 style="font-family: Roboto; font-weight: bold; font-size: 8px; color: #2d3665; float: left;">Date Needed:</h1>
                <h1 style="font-family: arial; font-size: 8px; color: #2d3665; padding-left: 70px; font-weight: 200; margin-bottom: 0.1rem;">${valueCheck.checkDate(order.servicesRequested.dateNeeded)}</h1>
            </div>
        </div>
        <div style="width: 50%; float: left;">
            <div style="width: 100%; float: left; ">
                ...
                <h1 style="font-family: arial; font-size: 8px; color: #2d3665; padding-left: 100px; font-weight: 200; margin-bottom: 0.1rem;">${valueCheck.isNullOrUndefined(order.servicesRequested.loanNumber)}</h1>
            </div>
        </div>
    ...
    <div style="background-color: white; border-bottom: 2px solid #575c77; padding-bottom: 10px; float: left; width: 90%; min-height: 1px; padding-left: 5%;">
        <div>
            <h1 style="font-family: arial; font-weight: 200; font-size: 12px; color: #363d71;  margin-bottom: 0.1rem;">Property Information</h1>
        </div>
    ...
    <div style="background-color: white; border-bottom: 2px solid #575c77; padding-bottom: 10px; float: left; width: 90%; min-height: 1px; padding-left: 5%;">
        <div>
            <h1 style="font-family: arial; font-weight: 200; font-size: 12px; color: #363d71;  margin-bottom: 0.1rem;">Owner</h1>
        </div>
    ...
    <div style="background-color: white; padding-bottom: 10px; float: left; width: 90%; min-height: 1px; padding-left: 5%;">
    <div>
        <h1 style="font-family: arial; font-weight: 200; font-size: 12px; color: #363d71;  margin-bottom: 0.1rem;">Additional Information</h1>
    </div>
